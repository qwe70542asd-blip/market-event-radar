...
- **Data Verification release barrier**：release push 時先等待 `live-tw-market` 達到 v11.4.36，再恢復來源並產生 verification，避免舊版 snapshot 搶跑。
...
完整修正與部署檢查見 `docs/V11.4.36.md`、`docs/V11.4.36-release-audit.md` 與 `VALIDATION.txt`。
