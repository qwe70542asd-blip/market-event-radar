# 市場事件雷達｜v10.8.4 新聞與公告整合版

這個資料夾是目前唯一應繼續修改的網站原始碼基準。

- 目前版本：`v10.8.4-news-announcements-integration`
- 專案網址：`https://qwe70542asd-blip.github.io/market-event-radar/`
- 顯示時區：`Asia/Taipei`（台灣時間）
- 目前狀態：保留已確認的桌機／手機排版與行情邏輯；重做月曆標頭、法人／官方公告卡片，新聞改為首次完整回補與滾動保留最近 20 天，核心資料每 5 分鐘檢查更新
...
- 新聞與官方公告更新失敗時，Action 必須明確失敗，不得發布空白檔案卻顯示成功。
