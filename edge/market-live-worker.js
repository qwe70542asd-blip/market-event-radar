/**
 * Market Event Radar v11.4.52 edge live-market service.
 * Public read-only market data. Deployment credentials never enter runtime.
 */
const VERSION="v11.4.52";
