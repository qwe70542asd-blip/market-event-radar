#!/usr/bin/env python3
"""Build grouped index and ETF market snapshots for Market Event Radar v10.5.1.
...
HEADERS = {
    "User-Agent": "Mozilla/5.0 (compatible; MarketEventRadar/10.5.1; +https://github.com/qwe70542asd-blip/market-event-radar)",
...
def main() -> int:
    ...
    payload = {
        "metadata": {
            "updated_at":iso(NOW), "timezone":"Asia/Taipei", "version":"v10.5.1",
