...
VERSION = "v11.4.32"
HEADERS = {
    "User-Agent": "Mozilla/5.0 (compatible; MarketEventRadar/11.4.32)",
...
def daily_reference(candles: list[dict[str, Any]], live_price: float | None, market_date: str | None = None) -> dict[str, Any]:
    ...
    The v11.4.32 publisher uses same-session-price-vs-adjacent-close. This
