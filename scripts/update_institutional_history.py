#!/usr/bin/env python3
"""Update TWSE institutional history and stock rankings for v10.4.6."""
...
HEADERS = {
    "User-Agent":"Mozilla/5.0 (compatible; MarketEventRadar/10.4.6; +https://github.com/qwe70542asd-blip/market-event-radar)",
