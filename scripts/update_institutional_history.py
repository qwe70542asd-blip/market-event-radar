#!/usr/bin/env python3
"""Update TWSE institutional history and stock rankings for v10.5.0."""
...
HEADERS = {
    "User-Agent":"Mozilla/5.0 (compatible; MarketEventRadar/10.5.0; +https://github.com/qwe70542asd-blip/market-event-radar)",
