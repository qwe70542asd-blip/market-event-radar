...
v11.4.36 validates the restored archive before reuse and backfills every calendar month from the official TWSE/TPEx network sources.
...
VERSION = "v11.4.36"
HEADERS = {"User-Agent": "Mozilla/5.0 (compatible; MarketEventRadar/11.4.36)"}
    ...
    for raw in [*old_rows, *online_rows]:
        ...
        for key in ("twse_trade_value", "tpex_trade_value"):
            ...
            if value is not None and value > 0:
                row[key] = value
        # Older files may only have a total. Preserve an explicit v11.4.36
...
def main() -> None:
    ...
    volume_payload = {
        "metadata": {
            ...
            "migration": "v11.4.36 backfills every month, rejects partial-market averages, and removes legacy weekend/future turnover rows",
