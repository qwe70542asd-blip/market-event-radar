...
def main():
 ...
 old["metadata"]={**old.get("metadata",{}),"version":"v11.4.6","updated_at":NOW.isoformat(timespec="seconds"),"trading_date":old.get("metadata",{}).get("trading_date"),"source":"TWSE／TPEx official after-hours data","note":"保留最後成功資料；缺值不以 0 代替。"}
