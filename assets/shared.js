...
async function loadNewsChannels(){
 ...
 return {metadata:{version:"v11.4.6",updated_at:updated,item_count:items.length,channel_count:channels.length},channels,items};
}
async function loadStockNews(){
 const fallback=window.__STOCK_NEWS_SEED__||{metadata:{version:"v11.4.6",status:"waiting",item_count:0},items:[]};
