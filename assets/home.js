(async()=>{
  ...
  let current=new Date(),focus="all",calendarMode=localStorage.getItem("mr-calendar-mode-v11.4.19")==="dividend"?"dividend":"market",pendingJumpDate="";
  ...
  function setCalendarMode(mode,{render=true}={}){
    ...
    localStorage.setItem("mr-calendar-mode-v11.4.19",calendarMode);
