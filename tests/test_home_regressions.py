...
def test_calendar_advanced_filters_are_collapsed_by_default():
    html=read("index.html");css=read("assets/v11.4.58-overrides.css")
...
def test_phone_quick_nav_is_single_source_but_hidden_in_favor_of_bottom_nav():
    html=read("index.html");shared=read("assets/shared.js");css=read("assets/v11.4.58-overrides.css")
